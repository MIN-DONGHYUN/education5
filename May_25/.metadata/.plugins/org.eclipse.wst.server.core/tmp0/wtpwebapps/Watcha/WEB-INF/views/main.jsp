   ...
   <h5 class="h5 main-h5">박스 오피스 순위</h5>
	...
	<div class="container my-5">
		...
		<div class="card-deck main-carousel-card mb-5">
		  ...
		  <div class="card">
		    <img src="<%= ctxPath%>/resources/images/Chicken.png" class="card-img-top card-size" alt="...">
		    <div class="card-body ">
		  ...
		  <div class="card">
		    <img src="<%= ctxPath%>/resources/images/images.jpeg" class="card-img-top  card-size" alt="...">
		    <div class="card-body">
