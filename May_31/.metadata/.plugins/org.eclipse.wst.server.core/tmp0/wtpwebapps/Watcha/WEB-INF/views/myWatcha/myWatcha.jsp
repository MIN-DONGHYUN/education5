...
span#movieRateCount, span#reviewCount, span#collectionCount {padding-left: 10px; font-weight: 400; color: #666666; font-size: 14px;}
	...
	function myReviewPaging(currentShowPageNo){
		$.ajax({
			...
			success:function(json){
				...
				$("div#div_reviewPageBar").html("${requestScope.pageBar}")// 페이지바
			},
			error: function(request, status, error){
	            alert("code: "+request.status+"\n"+"message: "+request.responseText+"\n"+"error: "+error);
	        }
		});		
	} // end of function myReviewPaging()
	  ...
	  <div id="div_myContent">
	  	...
	  	<div id="div_nav_content" class="tab-content pt-4 pb-3 my-3"> <%-- 평가한 영화 / 한줄평 / 컬렉션 / 무비다이어리 --%>
	        ...
	        <div style="display: flex; padding: 0 50px;" class="row mx-auto">
	 	      <h5 class="col-md-9" style="padding-left: 5px; font-weight: 600;">평가한 영화<span id="movieRateCount">${requestScope.userInfo.count_rating}</span></h5>
