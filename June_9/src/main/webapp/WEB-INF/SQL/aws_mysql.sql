...
where schema_name = 'favorite_db';
/* 
------------------------------------------------------------------------------------------------------------------------
catalog_name    schema_name     default_character_set_name      default_collation_name  sql_path    default_encryption
------------------------------------------------------------------------------------------------------------------------
def	            favorite_db	        utf8mb4	                        utf8mb4_0900_ai_ci		(null)      NO
*/
...
/*
FUNCTION favorite_db.get_seq does not exist
...
SELECT table_name, table_comment
FROM information_schema.tables
WHERE table_schema = 'favorite_db'; 
/*
------------------------------------------
...
SELECT table_name, table_comment
FROM information_schema.tables
WHERE table_schema = 'favorite_db' AND table_name = 'tbl_person_interest';
/*
------------------------------------------
TABLE_NAME              TABLE_COMMENT
-------------------------------------------
