...
<div class="container" style="padding: 0;">
   <h5 class="h5 main-h5">박스 오피스 순위</h5>
	...
	<h5 class="h5 main-h5 main-h5-3">평균별점이 높은 작품</h5>
   	 <div class="container my-3">
	...
	<h5 class="h5 main-h5 main-h5-3">작가별</h5>
   	 <div class="container my-3">
	...
	<h5 class="h5 main-h5 main-h5-3">왓챠피디아 컬렉션</h5>
		...
		<div class="card-deck main-carousel-card mb-5">
		  ...
		  <a href = "" title="범죄도시" class="Main-a">
			  <div class="Main-card">
			  	<div class="Main-card-header" style="display: flex;">
			    	<img src="<%= ctxPath%>/resources/images/범죄도시.jpg" class="card-img-top" alt="..." style="width: 50%; height: 50%;">
			    	<img src="<%= ctxPath%>/resources/images/범죄도시.jpg" class="card-img-top" alt="..." style="width: 50%; height: 50%;">
			    	<img src="<%= ctxPath%>/resources/images/범죄도시.jpg" class="card-img-top" alt="..." style="width: 50%; height: 50%;">
			    	<img src="<%= ctxPath%>/resources/images/범죄도시.jpg" class="card-img-top" alt="..." style="width: 50%; height: 50%;">
			    </div>			 
