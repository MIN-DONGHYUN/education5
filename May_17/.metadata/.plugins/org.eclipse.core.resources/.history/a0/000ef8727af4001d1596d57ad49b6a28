...
<div style="margin: auto; padding-left: 3%;">
   ...
   <h2 style="margin-bottom: 30px;">글내용보기</h2>
    ...
    <c:if test="${not empty requestScope.boardvo}">
       ...
       <div style="margin-bottom: 1%;">이전글제목&nbsp;&nbsp;<span class="move" onclick="javascript:location.href='<%=ctxPath%>/view_2.action?seq=${requestScope.boardvo.previousseq}&searchType=${requestScope.paraMap.searchType}&searchWord=${requestScope.paraMap.searchWord}'">${requestScope.boardvo.previoussubject}</span></div>
       <div style="margin-bottom: 1%;">다음글제목&nbsp;&nbsp;<span class="move" onclick="javascript:location.href='<%=ctxPath%>/view_2.action?seq=${requestScope.boardvo.nextseq}&searchType=${requestScope.paraMap.searchType}&searchWord=${requestScope.paraMap.searchWord}'">${requestScope.boardvo.nextsubject}</span></div>
       <br/> 
