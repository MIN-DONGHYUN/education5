			  ...
			  $.ajax({
				 ...
				 success:function(json) {
					 ...
					 if(json.length > 0){
						...
						// 검색되어진 길이를 알아오자 
						const input_width = $("input#searchWord").css("width");   // 검색어 input 태그 width 를 알아오기 
	         ...
	         <c:forEach var="boardvo" items="${requestScope.boardList}">
	         	 <tr>
		         	 ...
		         	 <td>
				        ...
				        <c:if test="${boardvo.depthno == 0}">      답변인지 아닌지 확인 하는 것은 depthno  0 이면 원글 0보다 크면 답변 	 
