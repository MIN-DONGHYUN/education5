 ...
 * Generated at: 2023-06-07 00:14:19 UTC
...
public final class scheduleManagement_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//     /board
      ...
      out.write("    	// === 구글캘린더를 이용하여 대한민국 공휴일 표시하기 시작 === //\r\n");
      out.write("        //   googleCalendarApiKey : \"자신의 Google API KEY 입력\",\r\n");
      out.write("         /*\r\n");
      out.write("             >> 자신의 Google API KEY 을 만드는 방법 <<\r\n");
      out.write("             1. 먼저 크롬 웹브라우저를 띄우고, 자신의 구글 계정으로 로그인 한다.\r\n");
      out.write("             2. https://console.developers.google.com 에 접속한다. \r\n");
      out.write("             3. \"API  API 및 서비스\" 에서 \"사용자 인증 정보\" 를 클릭한다.\r\n");
      out.write("             4. ! 이 페이지를 보려면 프로젝트를 선택하세요 에서 \"프로젝트 만들기\" 를 클릭한다.\r\n");
      out.write("             5. 프로젝트 이름은 자동으로 나오는 값을 그대로 두고 그냥 \"만들기\" 버튼을 클릭한다. \r\n");
      out.write("             6. 상단에 보여지는 사용자 인증 정보 옆의  \"+ 사용자 인증 정보 만들기\" 를 클릭하여 보여지는 API 키를 클릭한다.\r\n");
      out.write("                             그러면 API 키 생성되어진다.\r\n");
      out.write("             7. 생성된 API 키가  자신의 Google API KEY 이다.\r\n");
      out.write("             8. 애플리케이션에 대한 정보를 포함하여 OAuth 동의 화면을 구성해야 합니다. 에서 \"동의 화면 구성\" 버튼을 클릭한다.\r\n");
      out.write("             9. OAuth 동의 화면 --> User Type --> 외부를 선택하고 \"만들기\" 버튼을 클릭한다.\r\n");
      out.write("            10. 앱 정보 --> 앱 이름에는 \"웹개발테스트\"\r\n");
      out.write("                      --> 사용자 지원 이메일에는 자신의 구글계정 이메일 입력\r\n");
      out.write("                              하단부에 보이는 개발자 연락처 정보 --> 이메일 주소에는 자신의 구글계정 이메일 입력 \r\n");
      out.write("            11. \"저장 후 계속\" 버튼을 클릭한다. \r\n");
      out.write("            12. 범위 --> \"저장 후 계속\" 버튼을 클릭한다.\r\n");
      out.write("            13. 테스트 사용자 --> \"저장 후 계속\" 버튼을 클릭한다.\r\n");
      out.write("            14. \"API  API 및 서비스\" 에서 \"라이브러리\" 를 클릭한다.\r\n");
      out.write("                Google Workspace --> Google Calendar API 를 클릭한다.\r\n");
      out.write("                \"사용\" 버튼을 클릭한다. \r\n");
      out.write("         */\r\n");
      out.write("        googleCalendarApiKey : \"AIzaSyDWDJY0npYGr-nd0Sfn2uN7rOurjNkxmO4\",\r\n");
      out.write("         eventSources : [ \r\n");
      out.write("            {\r\n");
      out.write("             //  googleCalendarId : '대한민국의 휴일 캘린더 통합 캘린더 ID'\r\n");
      out.write("                 googleCalendarId : 'ko.south_korea#holiday@group.v.calendar.google.com'\r\n");
      out.write("               , color: 'white'   // 옵션임! 옵션참고 사이트 https://fullcalendar.io/docs/event-source-object\r\n");
      out.write("               , textColor: 'red' // 옵션임! 옵션참고 사이트 https://fullcalendar.io/docs/event-source-object\r\n");
      out.write("             } \r\n");
      out.write("         ],\r\n");
      out.write("         // === 구글캘린더를 이용하여 대한민국 공휴일 표시하기 끝 === //\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/tiles1/schedule/scheduleManagement.jsp(744,6) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
